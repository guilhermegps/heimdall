 ...
 * @author guilherme
 */
public class ComponenteRevisado implements Serializable {
    private String RFID;
    ...
    public ComponenteRevisado(String RFID, String idVeiculo, boolean identificado, String motivoNaoIdentificado, Timestamp identificao) {
        this.RFID = RFID;
